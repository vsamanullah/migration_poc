...
### Test Case 04: DELETE Author
**File**: `04_Authors_DELETE.jmx`
...
### Test Case 05: GET All Books
**File**: `05_Books_GET_All.jmx`
...
### Test Case 06: GET Book by ID
**File**: `06_Books_GET_ById.jmx`
...
### Test Case 07: POST Create Book
**File**: `07_Books_POST_Create.jmx`
...
### Test Case 08: DELETE Book
**File**: `8_Books_DELETE.jmx`
...
5. **05_Books_GET_All.jmx** - Books read performance
6. **06_Books_GET_ById.jmx** - Single book retrieval
7. **07_Books_POST_Create.jmx** - Books create load test
8. **04_Authors_DELETE.jmx** - Author deletion (requires recreation)
9. **8_Books_DELETE.jmx** - Book deletion (requires recreation)
