# Book Service Functional Tests

Playwright-based test suite for the Book Store application, designed to validate consistency between Source and Target environments during migration.
...
**Note**: The parent directory also contains `api_config.json` and `db_config.json` for performance and data testing. See [Book Store README](../README.md) for details.
...
Beyond functional testing, the Book Store application includes:
...
| Task | Location |
|------|----------|
| Functional Tests | [book_store/functional_tests](.) |
| Performance Tests | [book_store/performance_tests](../performance_tests/README.md) |
| Data Integrity | [book_store/data_testing](../data_testing/data_integrity_tests/README.md) |
| Main Documentation | [book_store/README.md](../README.md) |
